...
# generate right now is (B,T) where B = 5, T=7
...
for i in range(num_return_sequences):
    token_tensor = x[i, :max_length]
    tokens = token_tensor.tolist()
    #print(f"Tokens (list): {tokens}")  # Print to verify conversion
    #print(f"Type of tokens: {type(tokens)}")  # Print type to ensure it's a list
